 ...
 * Description:       Add featured video block
 ...
 * Text Domain:       oese-featured-video-block
 *
 * @package           oese-block
 */
...
function oese_block_oese_featured_video_block_block_init() {
	  ...
	  wp_register_style('oese_featured_video_block_editor_css', $__oese_relative_path.'/build/index.css',array( 'wp-edit-blocks' ),null);
	  wp_register_style('oese_featured_video_block_front_css', $__oese_relative_path.'/build/style-index.css',array( 'wp-edit-blocks' ),null);
	  wp_localize_script('oese_featured_video_block_js', 'oese_featured_video_isjson', $__oese_isjson);
	 	register_block_type(
		 	 'oese-block/oese-featured-video-block', array(
			 		 'editor_script' => 'oese_featured_video_block_js',
			 		 'editor_style'  => 'oese_featured_video_block_editor_css',
			 		 'style'         => 'oese_featured_video_block_front_css'
		 	 )
	  );
}
...
function oese_featured_video_block_frontend_script(){
 ...
 wp_localize_script('oese_featured_video_block-frontend-js', 'oese_featured_video_block_video_origin', get_bloginfo('wpurl'));
}
