 ...
 */
 ...
 function oese_blocks_oese_featured_item_block_block_init() {
  ...
  wp_register_script('oese_featured_item_block_backend_js', $__oese_relative_path.'/backend.js',array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'jquery' ), null, true );
  wp_localize_script('oese_featured_item_block_js', 'oese_featured_item_isjson', true);
   register_block_type(
 ...
 function oese_blocks_oese_featured_item_block_block_init_legacy(){
 	...
 	wp_register_style('oese_featured_item_block_front_css', $__oese_relative_path.'/build/style-index.css',array( 'wp-edit-blocks' ),null);
  wp_register_script('oese_featured_item_block_backend_js', $__oese_relative_path.'/backend.js',array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'jquery' ), null, true );
  wp_localize_script('oese_featured_item_block_js', 'oese_featured_item_isjson', false);
   register_block_type(
 		'oese-block/oese-featured-item-block', array(
 			'editor_script' => 'oese_featured_item_block_js',
 			'editor_style'  => 'oese_featured_item_block_editor_css',
...
function oese_featured_item_block_backend_script(){
 $__oese_relative_path = (strpos(__DIR__, 'shortcodesblockv2') !== false)? get_stylesheet_directory_uri().'/modules/shortcodesblockv2/featured_item/':plugin_dir_url( __FILE__ );
 wp_enqueue_script('oese_featured_item_block_backend_js', $__oese_relative_path.'/backend.js',array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'jquery' ), '1.0' );
}
...
function oese_featured_item_loadconditional_toolbar_css_legacy(){
	...
	?>
		...
		.block-editor__container.oese-featured-item-button-toolbar-hide .edit-post-visual-editor .block-editor-block-toolbar>div:nth-of-type(2)>div:nth-of-type(1),
...
function oese_featured_item_loadconditional_toolbar_css(){
	...
	?>
		...
		.block-editor__container.oese-featured-item-button-toolbar-hide .edit-post-visual-editor .block-editor-block-toolbar>div:nth-of-type(3)>div>div>button:nth-of-type(1),
