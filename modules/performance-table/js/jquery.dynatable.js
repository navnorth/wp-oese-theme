...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationPrev: '<img src="'+templateUrl+'/modules/performance-table/img/chevron-single-left.png" alt="previous page" />',
    ...
    dataset: {
      ...
      page: null,
      perPageDefault: 10,
      perPageOptions: [5,10,20,50,100,-1],
      perPageOptionsText: [5,10,20,50,100,'ALL'],
      sorts: {},
      sortsKeys: [],
      sortTypes: {},
      records: null
    ...
    this.create = function() {
      ...
      for (var i = 0, len = settings.dataset.perPageOptions.length; i < len; i++) {
        var number = settings.dataset.perPageOptions[i],
            ...
            numbertext = settings.dataset.perPageOptionsText[i];
            
        $select.append('<option value="' + number + '" ' + selected + '>' + numbertext + '</option>');
      }
