                ...
                <div class="col-sm-12 program-sidebar">
                    ...
                    <div class="tab-content" id="mobileSidebarTabContent">
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="tab-close-row"><a class="tab-close-button"  onClick="" style="cursor:pointer" data-role="button" role="button"><i class="fas fa-times"></i> CLOSE</a></div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="menu" role="tabpanel" aria-labelledby="menu-tab">
                            ...
                            <div class="col-sm-12 tab-close-row"><a class="tab-close-button"  onClick="" style="cursor:pointer" data-role="button" role="button"><i class="fas fa-times"></i> CLOSE</a></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
