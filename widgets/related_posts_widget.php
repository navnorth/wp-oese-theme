...
class Related_Posts_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'related-posts', 'description' => __('A widget that displays latest related posts according to category of a post/page ', 'OII') );
...
<?php
    ...
    function form( $instance ){
        ...
        $defaults = array( 'title' => __('Related Posts', 'OII'), 'show_date' => 'on', 'show_thumbnail' => 'off', 'posts_count' => 5 );
